                        ...
                        children: [
                          Column(
                            children: [
                              ...
                              Padding(
                                padding:
                                    const EdgeInsets.only(right: 115, top: 5),
                                child: Text(
                                  "BCA",
                                  style: TextStyle(
                                    color: Colors.grey,
                        ...
                        children: [
                          Column(
                            children: [
                              ...
                              Padding(
                                padding:
                                    const EdgeInsets.only(right: 80, top: 5),
                                child: Text(
                                  "BCA",
                                  style: TextStyle(
                                    color: Colors.grey,
                        ...
                        children: [
                          Column(
                            children: [
                              ...
                              Padding(
                                padding:
                                    const EdgeInsets.only(right: 114, top: 5),
                                child: Text(
                                  "BCA",
                                  style: TextStyle(
                                    color: Colors.grey,
