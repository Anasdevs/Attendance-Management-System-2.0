...
admin.site.register(Bca_Student)
admin.site.register(Bca_Attendance)
admin.site.register(Bba_Student)
admin.site.register(Bba_Attendance)
admin.site.register(B_Com_Student)
admin.site.register(B_Com_Attendance)
admin.site.register(B_Ed_Student)
admin.site.register(B_Ed_Attendance)
admin.site.register(Mba_Student)
